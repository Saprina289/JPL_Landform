...
def img_to_xmp(filename):
    ...
    for filename in os.listdir(INPUTDIR): #for every IMG img in the given filename path
        ...
        with open(INPUTDIR+'/'+filename,'rb') as f:
            ...
            pixel_size = 0.46/(float(focal_len)) #using formula to calculate pixel size for given pixel scale and focal length
...
if __name__ == "__main__":
    ...
    root_path = os.getcwd() 
    new_sol_folder_path = os.path.join(root_path, "sol" + sol + "_HAZcam")
