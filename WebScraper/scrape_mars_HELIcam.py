...
#IMAGE CONSTANTS - given in HeliCAM tech specs
img_height = 1600
img_width = 1200
    ...
    for filename in os.listdir(INPUTDIR): #for every IMG img in the given filename path
        ...
        with open(INPUTDIR+'/'+filename,'rb') as f:
            ...
            while continuing == 1:
                ...
                #     focal_len = s.split(" ")[1]  #paper says use hs hs = f or f = hs
...
if __name__ == "__main__":
    ...
    root_path = os.getcwd() 
    new_sol_folder_path = os.path.join(root_path, "sol" + sol + "_HELIcam")
